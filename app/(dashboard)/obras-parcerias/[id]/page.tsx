          ...
          <CardContent className="pt-4">
            <form onSubmit={handleSave} className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="sm:col-span-3">
                <label className="block text-xs font-medium text-gray-600 mb-1">Descrição *</label>
                <input required value={form.description} onChange={f("description")} placeholder="Ex: Aluguel de andaime" className="w-full text-sm border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#EA580C]" />
              </div>
              <div>
