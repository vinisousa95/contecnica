...
const AUTH_PATTERNS: RegExp[] = [
  ...
  // O PIN financeiro NÃO entra aqui: o balde de auth conta toda requisição
  // (inclusive PIN certo), então bloquear/entrar várias vezes travava o PIN
  // legítimo. A proteção contra brute-force do PIN é feita na própria rota,
  // contando só as tentativas ERRADAS. Ver app/api/v1/verify-finance-pin.
];
