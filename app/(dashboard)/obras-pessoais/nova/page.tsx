...
export default function NovaObraPessoalPage() {
  ...
  return (
    <div className="max-w-2xl space-y-5">
      <PageHeader title="Nova Obra Pessoal" description="Cadastre uma obra ou projeto pessoal"
        actions={<Button variant="outline" size="sm" asChild><Link href="/obras-pessoais"><ArrowLeft className="h-4 w-4" />Voltar</Link></Button>}
      />
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex justify-end gap-3">
          <Button variant="outline" type="button" asChild><Link href="/obras-pessoais">Cancelar</Link></Button>
