  ...
  return (
    <div className="space-y-6">
      ...
      {project.status === "COMPLETED" && (
        <a
          href={`/portal/relatorio/${projectId}`}
          target="_blank"
        ...
        >
          ...
          <div className="min-w-0">
            <p className="text-sm font-semibold text-green-800">Relatório de conclusão da obra</p>
            <p className="text-xs text-green-700">Abrir e baixar em PDF — resumo, pagamentos e fotos.</p>
          </div>
        </a>
      )}
